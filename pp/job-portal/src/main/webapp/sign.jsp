...
<%
    request.removeAttribute("succMsg"); // Remove message after displaying
    }
%>
...
<label for=exampleInputPassword1">Enter password</label><input type="password" required="required" class="form-control" id="exampleInputPassword1" name="ps"></div>
							<button type="submit"
								class="btn btnn-primary badge-pill btn-block"
								style="border: 2px solid black; width: 80px; display: block; margin: 0 auto;">Login</button>
						</form>
</div>
